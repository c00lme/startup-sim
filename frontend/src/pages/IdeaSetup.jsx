...
const realismLevels = [
  ...
  },
  {
    ...
    value: "harsh",
    icon: "🔥",
    description: "Investor-level scrutiny",
  },
];
...
export default function IdeaSetup({ onStart }) {
  ...
  const [agents, setAgents] = useState([
    ...
    { role: "Unpaid Intern", personality: "neutral" },
  ...
  return (
    <div className="min-h-screen font-sans text-gray-900 overflow-hidden relative">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md shadow-md py-4 px-6">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-indigo-500 to-pink-500 flex items-center justify-center text-white font-black text-xl shadow-lg">
              S
            </div>
            <span className="text-2xl font-black bg-gradient-to-r from-indigo-700 to-pink-600 bg-clip-text text-transparent">
              startNOW
            </span>
          </div>
          ...
          <div className="flex flex-col lg:flex-row items-center lg:space-x-12">
            <div className="lg:w-1/2 mb-10 lg:mb-0 text-center lg:text-left">
              ...
              <p className="text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
                Get feedback, insights, and pitch decks from AI experts who know
                what investors{" "}
                <span className="italic font-semibold">really</span> want to
                hear.
              </p>
                ...
                <div className="space-y-4">
                  <div className="bg-indigo-50 p-4 rounded-xl">
                    <div className="flex items-start">
                      <div className="w-8 h-8 rounded-full bg-indigo-600 flex items-center justify-center text-white font-bold mr-3 mt-1">
                        PM
                      </div>
                      <div>
                        ...
                        <p className="text-gray-700">
                          Your target market needs more clarity. Who exactly is
                          this for?
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="bg-purple-50 p-4 rounded-xl">
                    <div className="flex items-start">
                      <div className="w-8 h-8 rounded-full bg-purple-600 flex items-center justify-center text-white font-bold mr-3 mt-1">
                        CT
                      </div>
                      <div>
                        <div className="text-purple-800 font-medium">CTO</div>
                        <p className="text-gray-700">
                          The tech is feasible, but we'll need to consider
                  ...
                  <div className="bg-pink-50 p-4 rounded-xl">
                    <div className="flex items-start">
                      <div className="w-8 h-8 rounded-full bg-pink-600 flex items-center justify-center text-white font-bold mr-3 mt-1">
                        IN
                      </div>
                      <div>
                        ...
                        <p className="text-gray-700">
                          I like the vision, but what's your revenue model? Show
                          me the numbers.
                        </p>
                      </div>
                    </div>
      ...
      <section
        ...
        className="py-20 px-6 bg-gradient-to-b from-white/50 to-indigo-50/50"
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-700 max-w-3xl mx-auto">
              Our AI-powered platform simulates realistic startup feedback,
              helping you perfect your pitch before facing real investors.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Collaborate with AI experts—each with unique personalities—to refine your vision and identify blind spots.",
                delay: 0.1,
              },
              {
                icon: "📊",
                ...
                description:
                  "Generate stunning 7-slide decks that address investor concerns and highlight your startup's unique strengths.",
                delay: 0.2,
              },
              {
                icon: "🎯",
                ...
                description:
                  "Switch between supportive, realistic, or harsh feedback to stress-test your ideas at different stages.",
                delay: 0.3,
              },
              {
                icon: "⚙️",
                ...
                description:
                  "Tailor agent personalities and roles for a truly personalized simulation experience.",
                delay: 0.4,
              },
              {
                icon: "📑",
                ...
                description:
                  "Download comprehensive session reports and risk maps to guide your next strategic steps.",
                delay: 0.5,
              },
              {
                icon: "🔄",
                ...
                description:
                  "Refine your idea through multiple rounds of feedback until it's investor-ready.",
                delay: 0.6,
              },
            ].map((benefit, index) => (
              <motion.div
          ...
          <motion.div
            ...
            className="mt-20"
          >
            <h3 className="text-3xl font-bold text-center mb-12 text-indigo-900">
              How startNOW Works
            </h3>
            <div className="flex flex-col md:flex-row justify-between items-center md:items-start space-y-8 md:space-y-0">
              {[
                ...
                },
                {
                  ...
                  description: "Choose agent roles and feedback style.",
                },
                {
                  number: "03",
                  title: "Get Expert Feedback",
                  description: "Receive insights from AI startup experts.",
                },
                {
                  number: "04",
                ...
                <div
                  key={index}
                  className="flex flex-col items-center md:items-start text-center md:text-left md:w-1/4 relative"
                >
      ...
      <section
        id="idea"
        ref={ideaSectionRef}
        className="py-20 px-6 bg-gradient-to-t from-indigo-50/80 to-white/40"
      >
              ...
              <div className="md:col-span-2 p-8">
                ...
                <div className="mb-8">
                  <h4 className="font-bold text-indigo-600 mb-4 flex items-center">
                    <span className="inline-block w-6 h-6 bg-indigo-100 rounded-full text-indigo-500 flex items-center justify-center mr-2">
                      1
                    </span>
                    Choose Your Experts
                  </h4>
                ...
                <div className="mt-10 bg-indigo-50 rounded-xl p-4">
                  ...
                  <p className="text-sm text-gray-700">
                    Users who choose{" "}
                    <b>
                      {realismLevels.find((l) => l.value === realism)?.label}
                    </b>{" "}
                    feedback typically improve their pitch success rate by{" "}
                    <b>
                      {realism === "harsh"
                        ? "73%"
                        : realism === "realistic"
      ...
      <footer className="bg-indigo-900 text-white py-12 px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          <div>
            <div className="flex items-center space-x-2 mb-6">
              <div className="w-10 h-10 rounded-lg bg-gradient-to-br from-white/20 to-white/5 flex items-center justify-center text-white font-black text-xl">
                S
              </div>
              <span className="text-2xl font-black text-white">startNOW</span>
            </div>
            <p className="text-indigo-200 mb-6">
              The AI-powered startup simulator that helps founders perfect their
              pitch and build investor-ready businesses.
            </p>
              ...
              {["twitter", "facebook", "linkedin", "instagram"].map(
                (social) => (
                  <a
                    key={social}
                    href="#"
                    className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center hover:bg-white/20 transition-colors duration-200"
                  >
        ...
        <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-indigo-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-indigo-300 text-sm">
            © 2025 startNOW. All rights reserved.
          </p>
          <div className="flex space-x-6 mt-4 md:mt-0">
            <a
              href="#"
              className="text-indigo-300 hover:text-white text-sm transition-colors duration-200"
            >
              Privacy
            </a>
            <a
      ...
      <style jsx global>{`
        ...
        @keyframes float-7 {
          ...
          50% {
            transform: translate(-50%, -50%) translate(15px, 15px) rotate(10deg);
          }
        }
        @keyframes float-8 {
          0%,
